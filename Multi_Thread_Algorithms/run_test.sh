...
echo "\n========== gcc -O2 =========="
echo "Peterson's algorithm"
gcc -O2 -Wall -D_P -pthread mutex_lock_test.c && ./a.out
echo "Dekker's algorithm"
gcc -O2 -Wall -D_D -pthread mutex_lock_test.c && ./a.out
echo "pthread_mutex_lock"
gcc -O2 -Wall -D_PTHREAD -pthread mutex_lock_test.c && ./a.out

echo "\n========== clang -O2 =========="
echo "Peterson's algorithm"
clang -O2 -Wall -D_P -pthread mutex_lock_test.c && ./a.out
echo "Dekker's algorithm"
clang -O2 -Wall -D_D -pthread mutex_lock_test.c && ./a.out
echo "pthread_mutex_lock"
clang -O2 -Wall -D_PTHREAD -pthread mutex_lock_test.c && ./a.out
